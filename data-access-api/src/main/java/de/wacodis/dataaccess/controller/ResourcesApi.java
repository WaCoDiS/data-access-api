/**
 * NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech) (3.3.3).
...
public interface ResourcesApi {
    ...
    default ResponseEntity<Map<String, List<AbstractResource>>> searchResources(
            @ApiParam(value = "search criteria ", required = true) @Valid @RequestBody DataAccessResourceSearchBody dataAccessResourceSearchBody) {
        //basic example
